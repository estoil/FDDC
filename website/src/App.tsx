  ...
  return <>
    <main>
      <section className="project-hero" id="top">
        <div className="hero-background" aria-hidden="true"><video src="./media/hero-video-v2.mp4" muted loop autoPlay playsInline preload="auto" onLoadedMetadata={(event) => { event.currentTarget.currentTime = 0 }} /><div /></div>
        ...
        <div className="project-header">
          ...
          <h1>A Change of Frame Makes Balance Observable:</h1>
          <p className="hero-subtitle">Distillation-Free Humanoid Single-Leg Stance</p>
