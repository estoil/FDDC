...
Single-page research website for **First Deployable Dynamic-CoM** and its Unitree G1 real-robot demonstrations.
...
- selects 25 balanced left/right FDDC clips and creates grid/detail versions;
...
4. Wait for the **Deploy FDDC website** workflow to complete.
5. Open the Pages URL, expected for this repository as `https://estoil.github.io/FDDC/`.
...
- Add the live website URL near the top of the FDDC README.
